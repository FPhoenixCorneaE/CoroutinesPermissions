            ...
            requestPermissionsFragment.getPermissionsResultFlow().collect { result ->
                when (result) {
                    PermissionsResult.Granted -> {
                        println("requestPermissionsOnLifecycle: onGranted")
                        permissionsCallback.onGranted()
                    }
                    is PermissionsResult.Denied -> {
                        println("requestPermissionsOnLifecycle: onDenied: ${result.permissions}")
                        permissionsCallback.onDenied(result.permissions)
                    }
                    is PermissionsResult.ShowRationale -> {
                        println("requestPermissionsOnLifecycle: onShowRationale: ${result.permissions}")
                    ...
                    is PermissionsResult.NeverAsk -> {
                        println("requestPermissionsOnLifecycle: onNeverAsk: ${result.permissions}")
